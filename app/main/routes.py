...
@bp.route('/explore')
@login_required
def explore():  # функция просмотра всех сообщений
    page = request.args.get('page', 1, type=int)
    posts = Post.query.order_by(Post.timestamp.desc()).paginate(
        page, bp.config['POSTS_PER_PAGE'], False)
...
@bp.route('/unfollow/<username>', methods=['POST'])  # функция отписки от пользователя
@login_required
